...
Gene.prototype.mate = function(gene) {
    var pivot = Math.round(this.code.length / 4) - 1;

    var child1 = this.code.substr(0, pivot) + gene.code.substr(pivot);
    var child2 = gene.code.substr(0, pivot) + this.code.substr(pivot);
    var child3 = gene.code.substr(0, pivot) + this.code.substr(pivot);
    var child4 = gene.code.substr(0, pivot) + this.code.substr(pivot);
...
var population = new Population("I love PauPau!", 20);
