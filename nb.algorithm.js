...
// German Training
Bayes.train("Bensdorf ist eine Gemeinde mit über 1200 Einwohnern im Westen des Landes Brandenburg. Die Gemeinde entstand 1952 durch den Zusammenschluss der vier Gemeinden Altbensdorf, Neubensdorf, Woltersdorf und Vehlen und des Gutsbezirks Herrenhölzer. Der Name geht auf das bis zur Gründung Neubensdorfs im frühen 19. Jahrhundert Bensdorf genannte Altbensdorf zurück. Die Gemeinde gehört zum Amt Wusterwitz. Bensdorf, Vehlen und Woltersdorf wurden, soweit bekannt, erstmals im 14. Jahrhundert erwähnt. Sehenswürdigkeiten in den Orten der Gemeinde sind beispielsweise Dorfkirchen", 'german');
Bayes.train("Das Gemälde Lorenzo Pagans und Auguste de Gas ist ein Doppelbildnis in einem Innenraum. Als zentrale Figur sitzt in der Bildmitte der spanische Sänger Lorenzo Pagans frontal dem Bildbetrachter gegenüber, rechts hinter ihm hat Auguste de Gas, der Vater von Edgar Degas, Platz genommen.", 'german');
Bayes.train("Als Tyrannis (Tyrannenherrschaft) bezeichnet man eine Herrschaftsform der griechischen Antike, die im 7. Jahrhundert v. Chr. aufkam und bis in die Zeit des Hellenismus in griechisch besiedelten Regionen des Mittelmeerraums verbreitet war. Ihr Merkmal ist die unumschränkte Alleinherrschaft eines Machthabers, des „Tyrannen“ über einen Stadtstaat oder ein größeres Territorium. Die Grundlage dafür war keine herkömmliche Legitimation, sondern nur der faktische, auf Gewalt beruhende Machtbesitz, den in manchen Fällen eine Volksversammlung gebilligt hatte", 'german');
Bayes.train("war ein deutscher Historiker, der sich als Gegner der Weimarer Republik hervortat, unter den Nationalsozialisten führende wissenschaftliche Funktionen innehatte und ein knappes Jahrzehnt die Historische Zeitschrift herausgab. Im Ersten Weltkrieg propagierte er eine unverminderte Fortführung des Krieges.", 'german');
Bayes.train("Die Veröffentlichung der .NET-Plattform wurde von Microsoft erstmals im Jahr 2000 offiziell bekanntgegeben.[1] 2002 wurde das Framework als Teil von Visual Studio .NET dann veröffentlicht", 'german');
